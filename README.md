...
### Reference and Target Performance

For the purposes of benchmarking, the overall performance metric is
...
For the reference performance, we use the 128 GPU figures from
Isambard-AI, above. Q3 throughput is 512.411 GDoFs/s, equating to
512.411/128 = 4.003 GDoFs/s/device. Q6 thoughput is 505.677 GDoFs/s,
or 505.677/128 = 3.95 GDoFs/s/device. Taking the mean, we get a
combined performance of: (4.003 + 3.95)/2 = **3.98 GDoFs/s/device**. This
is the reference performance required.
